  ...
  try {
    ...
    for (const file of cssFiles.sort()) {
      ...
      if (originalLength !== processedLength) {
        console.log(`🔧 Stripped problematic CSS rules from ${file} (${originalLength} -> ${processedLength} chars)`);
      }
      ...
      console.log(`🐛 Debug: Saved CSS after stripProblematicRules to ${debugFileName}`);
      ...
      try {
        ...
        console.error(`❌ PostCSS processing failed for ${file}:`, error.message);
        process.exit(1);
      }
    }
